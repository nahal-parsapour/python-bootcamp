...
class TestAPI(unittest.TestCase):
    ...
    @patch('src.05RewriteEx1&2_api-client.requests.get')
    def test_fetch_all_titles(self, mock_get): # not empty & has 1title least
        mock_response = Mock()
    ...
    @patch('src.05RewriteEx1&2_api-client.requests.get')
    def test_fetch_titles_from_api(self, mock_get): # handles connection error
